...
public class JdbcDbWriterTest {
  ...
  @Test
  public void transactionShouldBeRolledBackWhenMultipleBeginEncountered() throws SQLException {
    String topic = "books";
    TableId tableId = new TableId(null, null, topic);
    ...
    records.add(new SinkRecord(topic, 0, keySchema, keyStruct, valueSchema, valueStruct, 3));
